...
<div class="layuimini-container">
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item  layui-row layui-col-xs12">
            <label class="layui-form-label required">{{ea_trans('Previous menu',true,'common')}}</label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label required">{{ea_trans('menu name',true,'common')}}</label>
            <div class="layui-input-block">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">{{ea_trans('menu url',true,'common')}}</label>
            <div class="layui-input-block">
                <input type="text" name="href" id="href" class="layui-input" placeholder="{{ea_trans('Please Enter',false)}}" value="{{$row['href']}}">
            </div>
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label">{{ea_trans('menu icon',true,'common')}}</label>
            <div class="layui-input-block">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">{{ea_trans('menu sort',true,'common')}}</label>
            <div class="layui-input-block">
                <input type="number" name="sort" placeholder="{{ea_trans('Please Enter',false)}}" value="{{$row['sort']}}" class="layui-input">
            </div>
        </div>
