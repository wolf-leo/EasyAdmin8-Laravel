...
<div class="layuimini-container">
    <form id="app-form" class="layui-form layuimini-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" id="href" name="href" class="layui-input" placeholder="{{ea_trans('Please Enter',false)}}" value="">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" name="sort" placeholder="{{ea_trans('Please Enter',false)}}" value="0" class="layui-input">
            </div>
        </div>
