...
define(["jquery", "miniMenu", "miniTheme", "miniTab"], function ($, miniMenu, miniTheme, miniTab) {
    ...
    var miniAdmin = {
        ...
        renderHome: function (data) {
            ...
            $('#layuiminiHomeTabId').html('<span class="layuimini-tab-active"></span><span class="disable-close">' + __(data.title) + '</span><i class="layui-icon layui-unselect layui-tab-close">ဆ</i>');
