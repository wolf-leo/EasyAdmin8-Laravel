...
>
> 请注意：当前项目采用 `laravel 11.x` 构建，如需要 `laravel 10.x` 请访问 [https://github.com/wolf-leo/EasyAdmin8-Laravel/tree/10.x](https://github.com/wolf-leo/EasyAdmin8-Laravel/tree/10.x)
>
